#ifndef NXMP_I18N_CN_S_H
#define NXMP_I18N_CN_S_H


const char *cn_s_i18n_author = "proconsule";
bool cn_s_i18n_status = false;
bool cn_s_i18n_native = false;

const char *MainMenu_STR_CN_S[] = {
	"Local Files",
	"USB",
	"Stream Url",
	"Network",
...
const char *SettingsMenu_STR_CN_S[] = {
	"Generals",
	"File Browser",
	"Show Hidden Files",
	"Navigation",
