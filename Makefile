...
LIBS	:=  -lmpv `curl-config --libs` `freetype-config --libs` -lswscale -lswresample -lavformat -lavfilter -lpostproc -lavcodec -lavutil -llzma -lopus -lvpx -lass -lharfbuzz -lfreetype -lfribidi -lmupdf -lmupdf-third -lfreetype  -lstdc++ -ldav1d -lpng -lbz2 -ltinyxml2 -lturbojpeg -llua5.1 -lssh2 -lmbedcrypto -lmbedx509 -lmbedtls -lmbedcrypto -lmbedx509 -lmbedtls -lsqlite3 -lsmb2  -lnfs -ljansson -lusbhsfs -lntfs-3g -llwext4 -ldeko3d -luam -larchive -lexpat -llzma -lzstd -llz4 -lbz2 -lz -lnx -lc -lz
